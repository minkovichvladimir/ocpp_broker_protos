...
const file_central_system_v1_central_system_proto_rawDesc = "" +
	"\n" +
	"&central_system/v1/central_system.proto\x12\x02cs\"z\n" +
	"\rCentralSystem\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12#\n" +
	"\rwebsocket_url\x18\x03 \x01(\tR\fwebsocketUrl\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\"w\n" +
	"\x1aCreateCentralSystemRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12#\n" +
	"\rwebsocket_url\x18\x02 \x01(\tR\fwebsocketUrl\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\"W\n" +
	"\x1bCreateCentralSystemResponse\x128\n" +
	"\x0ecentral_system\x18\x01 \x01(\v2\x11.cs.CentralSystemR\rcentralSystem\")\n" +
	"\x17GetCentralSystemRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\"T\n" +
	"\x18GetCentralSystemResponse\x128\n" +
	"\x0ecentral_system\x18\x01 \x01(\v2\x11.cs.CentralSystemR\rcentralSystem\"\x1b\n" +
	"\x19ListCentralSystemsRequest\"X\n" +
	"\x1aListCentralSystemsResponse\x12:\n" +
	"\x0fcentral_systems\x18\x01 \x03(\v2\x11.cs.CentralSystemR\x0ecentralSystems\"\x87\x01\n" +
	"\x1aUpdateCentralSystemRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12#\n" +
	"\rwebsocket_url\x18\x03 \x01(\tR\fwebsocketUrl\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\"W\n" +
	"\x1bUpdateCentralSystemResponse\x128\n" +
	"\x0ecentral_system\x18\x01 \x01(\v2\x11.cs.CentralSystemR\rcentralSystem\",\n" +
	"\x1aDeleteCentralSystemRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\"\x1d\n" +
	"\x1bDeleteCentralSystemResponse2\xcc\x03\n" +
	"\x14CentralSystemService\x12X\n" +
	"\x13CreateCentralSystem\x12\x1e.cs.CreateCentralSystemRequest\x1a\x1f.cs.CreateCentralSystemResponse\"\x00\x12O\n" +
	"\x10GetCentralSystem\x12\x1b.cs.GetCentralSystemRequest\x1a\x1c.cs.GetCentralSystemResponse\"\x00\x12U\n" +
	"\x12ListCentralSystems\x12\x1d.cs.ListCentralSystemsRequest\x1a\x1e.cs.ListCentralSystemsResponse\"\x00\x12X\n" +
	"\x13UpdateCentralSystem\x12\x1e.cs.UpdateCentralSystemRequest\x1a\x1f.cs.UpdateCentralSystemResponse\"\x00\x12X\n" +
	"\x13DeleteCentralSystem\x12\x1e.cs.DeleteCentralSystemRequest\x1a\x1f.cs.DeleteCentralSystemResponse\"\x00B,Z*ocpp_broker_protos.central_system.v1;cs_v1b\x06proto3"
