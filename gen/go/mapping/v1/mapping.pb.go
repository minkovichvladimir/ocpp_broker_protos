...
const file_mapping_v1_mapping_proto_rawDesc = "" +
	"\n" +
	"\x18mapping/v1/mapping.proto\x12\amapping\"\x17\n" +
	"\x15GetAllMappingsRequest\"F\n" +
	"\x16GetAllMappingsResponse\x12,\n" +
	"\bmappings\x18\x01 \x03(\v2\x10.mapping.MappingR\bmappings\"\xa8\x01\n" +
	"\aMapping\x12\x1d\n" +
	"\n" +
	"station_id\x18\x01 \x01(\tR\tstationId\x12*\n" +
	"\x11central_system_id\x18\x02 \x01(\x05R\x0fcentralSystemId\x12\x16\n" +
	"\x06weight\x18\x03 \x01(\x05R\x06weight\x12\x1b\n" +
	"\tis_master\x18\x04 \x01(\bR\bisMaster\x12\x1d\n" +
	"\n" +
	"is_enabled\x18\x05 \x01(\bR\tisEnabled\"\xb5\x01\n" +
	...
	"\tis_master\x18\x04 \x01(\bR\bisMaster\x12\x1d\n" +
	"\n" +
	"is_enabled\x18\x05 \x01(\bR\tisEnabled\"1\n" +
	"\x15CreateMappingResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\"\xb5\x01\n" +
	"\x14UpdateMappingRequest\x12\x1d\n" +
	"\n" +
	"station_id\x18\x01 \x01(\tR\tstationId\x12*\n" +
	"\x11central_system_id\x18\x02 \x01(\x05R\x0fcentralSystemId\x12\x16\n" +
	"\x06weight\x18\x03 \x01(\x05R\x06weight\x12\x1b\n" +
	...
	"\n" +
	"is_enabled\x18\x05 \x01(\bR\tisEnabled\"1\n" +
	"\x15UpdateMappingResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\"a\n" +
	"\x14DeleteMappingRequest\x12\x1d\n" +
	"\n" +
	"station_id\x18\x01 \x01(\tR\tstationId\x12*\n" +
	"\x11central_system_id\x18\x02 \x01(\x05R\x0fcentralSystemId\"1\n" +
	"\x15DeleteMappingResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess2\xdb\x02\n" +
	"\x0eMappingService\x12S\n" +
	"\x0eGetAllMappings\x12\x1e.mapping.GetAllMappingsRequest\x1a\x1f.mapping.GetAllMappingsResponse\"\x00\x12P\n" +
	"\rCreateMapping\x12\x1d.mapping.CreateMappingRequest\x1a\x1e.mapping.CreateMappingResponse\"\x00\x12P\n" +
	"\rUpdateMapping\x12\x1d.mapping.UpdateMappingRequest\x1a\x1e.mapping.UpdateMappingResponse\"\x00\x12P\n" +
	"\rDeleteMapping\x12\x1d.mapping.DeleteMappingRequest\x1a\x1e.mapping.DeleteMappingResponse\"\x00B)Z'ocpp_broker_protos.mapping.v1;mappingv1b\x06proto3"
